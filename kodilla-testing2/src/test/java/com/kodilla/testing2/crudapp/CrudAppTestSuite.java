...
public class CrudAppTestSuite {
    public static final String BASE_URL = "https://bauaser-kun.github.io//";
    ...
    private void sendTestTaskToTrello(String taskName) throws InterruptedException {
        ...
        driver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
                ...
                .forEach(theForm -> {
                    WebElement selectElemet = theForm.findElement(By.xpath(".//select[1]"));
                    Select select = new Select(selectElemet);
    ...
    public void shouldCreateTrelloCard() throws InterruptedException {
        ...
        deleteTaskFromCruddApp(taskName);
    }

    private void deleteTaskFromCruddApp(String taskName) throws InterruptedException {
