...
class BoardTestSuite {
    ...
    @Test
    void testAddTakListFindOutdatedTasks() {
        //Given
        Board project = prepareTestData();
    ...
    void testAddTaskListAverageWorkingOnTask(){
        ...
        long totalDaysPassed = project.getTaskLists().stream()
      ...
      double averageDaysPassedSinceTaskCreation = (double)(totalDaysPassed/tasksCount);

        //Then
        assertEquals(10.0, averageDaysPassedSinceTaskCreation);
    }
    ...
    Task task3 = new Task ("Temperatures entity",
        ...
        TaskList taskListIntProgress = new TaskList("In progress");
        taskListIntProgress.addTask(task5);
        taskListIntProgress.addTask(task4);
        taskListIntProgress.addTask(task2);
        ...
        project.addTaskList(taskListIntProgress);
